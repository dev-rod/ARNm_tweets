...
# if("R.utils" %in% rownames(installed.packages()) == FALSE) {install.packages("R.utils")};library(R.utils)
# setOption("future.rng.onMisuse", "ignore")
...
# Pour assembler le fichier complet des tweets
